...
def upgrade():
    ...
    op.drop_index(
        "ix_assembly_sponsorships_assembly_bill_id",
        table_name="assembly_sponsorships",
    )
    op.drop_index(
        "ix_assembly_sponsorships_assembly_member_id",
        table_name="assembly_sponsorships",
    )
    op.create_index(
        op.f("ix_assembly_sponsorships_bill_id"),
        "assembly_sponsorships",
        ["bill_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_assembly_sponsorships_person_id"),
        "assembly_sponsorships",
        ["person_id"],
        unique=False,
    )
    op.drop_constraint(
        "assembly_sponsorships_assembly_member_id_fkey",
        "assembly_sponsorships",
        type_="foreignkey",
    )
    op.drop_constraint(
        "assembly_sponsorships_assembly_bill_id_fkey",
        "assembly_sponsorships",
        type_="foreignkey",
    )
    ...
    op.drop_index(
        "ix_senate_sponsorships_senate_bill_id",
        table_name="senate_sponsorships",
    )
    op.drop_index(
        "ix_senate_sponsorships_senator_id", table_name="senate_sponsorships"
    )
    op.create_index(
        op.f("ix_senate_sponsorships_bill_id"),
        "senate_sponsorships",
        ["bill_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_senate_sponsorships_person_id"),
        "senate_sponsorships",
        ["person_id"],
        unique=False,
    )
    op.drop_constraint(
        "senate_sponsorships_senator_id_fkey",
        "senate_sponsorships",
        type_="foreignkey",
    )
    op.drop_constraint(
        "senate_sponsorships_senate_bill_id_fkey",
        "senate_sponsorships",
        type_="foreignkey",
    )
    op.create_foreign_key(
        None, "senate_sponsorships", "senators", ["person_id"], ["person_id"]
    )
    op.create_foreign_key(
        None, "senate_sponsorships", "senate_bills", ["bill_id"], ["bill_id"]
    )
...
def downgrade():
    ...
    op.create_index(
        "ix_senate_sponsorships_senator_id",
        "senate_sponsorships",
        ["senator_id"],
        unique=False,
    )
