...
def upgrade():
    ...
    op.create_index(op.f('ix_users_send_bill_update_notifications'), 'users', ['send_bill_update_notifications'], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_users_send_bill_update_notifications'), table_name='users')
