...
def _create_phone_bank_row_data(
    city_bill: CityBill,
...
def create_power_hour(
    ...
    row_data = _create_phone_bank_row_data(
        city_bill, sponsorships, non_sponsors, import_data
    )

    spreadsheet_result = create_spreadsheet(title, row_data, COLUMN_WIDTHS)
